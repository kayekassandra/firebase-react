        ...
        <div class="section padding-top-bottom-big over-hide background-white">
          ...
          <div class="container">
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-md-5 mb-4">
                <a href="./images/project-2/issa2019-popup-2weeksleft-ar.gif" class="cursor-link" data-fancybox="gallery">
                  <div class="img-wrap">
                    <img src="./images/project-2/issa2019-popup-2weeksleft-ar.gif" class="cursor-more" alt="Intersec Saudi Arabia" />
                  </div>
                </a>
              </div>
              <div class="col-md-5 mb-4">
                <a href="./images/project-2/issa2019-popup-2weeksleft-en.gif" class="cursor-link" data-fancybox="gallery">
                  <div class="img-wrap">
                    <img src="./images/project-2/issa2019-popup-2weeksleft-en.gif" class="cursor-more" alt="Intersec Saudi Arabia" />
                  </div>
                </a>
              </div>
              <div class="col-md-10 text-left color-grayglass">
